                ...
                ZStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .leading, spacing: 20) {
                            //QUESTION 1
                            VStack(spacing: 10) {
                                Text("The core principle of exotic charts is to")
                                    .font(.system(size: 17, weight: .semibold))
                                    .foregroundStyle(.white)
                                    .multilineTextAlignment(.center)

                                Button {
                                    selectionOne = "Remove time"
                                    if selectionOne == "Remove time" {
                                    ...
                                    HStack {
                                        Text("Remove time")
                                            ...
                                            .foregroundStyle(selectionOne == "Remove time" ? Color.white : Color.black)
                                    ...
                                    .padding(.horizontal)
                                    .padding(.vertical, 10)
                                    .background(selectionOne == "Remove time" ? Color.red : Color.white)
                                    .clipShape(RoundedRectangle(cornerRadius: 8))
                                }

                                Button {
                                    selectionOne = "Remove noise"
                                    if selectionOne == "Remove noise" {
                                    ...
                                    HStack {
                                        Text("Remove noise")
                                            .font(.system(size: 15, weight: .regular))
                                            .foregroundStyle(selectionOne == "Remove noise" ? Color.white : Color.black)
                                            .multilineTextAlignment(.leading)
                                    ...
                                    .padding(.horizontal)
                                    .padding(.vertical, 10)
                                    .background(selectionOne == "Remove noise" ? Color.blue : Color.white)
                                    .clipShape(RoundedRectangle(cornerRadius: 8))
                                }
                            }
                            .padding()
                            ...
                            //QUESTION 2
                            VStack(spacing: 10) {
                                Text("Some people consider exotic charting to be a trading system in its own right.")
                                    .font(.system(size: 17, weight: .semibold))
                                    .foregroundStyle(.white)
                                    .multilineTextAlignment(.center)
                            ...
                            //QUESTION 3
                            VStack(spacing: 10) {
                                Text("Point-and-figure charting and Renko charting discard data that does not meet the box or brick size.")
                                    .font(.system(size: 17, weight: .semibold))
                                    .foregroundStyle(.white)
                                    .multilineTextAlignment(.center)
                            ...
                            //QUESTION 4
                            VStack(spacing: 10) {
                                Text("Heikin-Ashi eliminates noise using")
                                    .font(.system(size: 17, weight: .semibold))
                                    .foregroundStyle(.white)
                                    .multilineTextAlignment(.center)

                                Button {
                                    selectionFour = "Discarding data"
                                    if selectionFour == "Discarding data" {
                                    ...
                                    HStack {
                                        Text("Discarding data")
                                            .font(.system(size: 15, weight: .regular))
                                            .foregroundStyle(selectionFour == "Discarding data" ? Color.white : Color.black)
                                            .multilineTextAlignment(.leading)
                                    ...
                                    .padding(.horizontal)
                                    .padding(.vertical, 10)
                                    .background(selectionFour == "Discarding data" ? Color.red : Color.white)
                                    .clipShape(RoundedRectangle(cornerRadius: 8))
                                }

                                Button {
                                    selectionFour = "Averaging"
                                    if selectionFour == "Averaging" {
                                    ...
                                    HStack {
                                        Text("Averaging")
                                            .font(.system(size: 15, weight: .regular))
                                            .foregroundStyle(selectionFour == "Averaging" ? Color.white : Color.black)
                                            .multilineTextAlignment(.leading)
                                    ...
                                    .padding(.horizontal)
                                    .padding(.vertical, 10)
                                    .background(selectionFour == "Averaging" ? Color.blue : Color.white)
                                    .clipShape(RoundedRectangle(cornerRadius: 8))
                                }
                            }
                            .padding()
